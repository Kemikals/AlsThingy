...
public class ComponentsBoard extends JPanel implements ActionListener {
    ...
    public final OperatingSystem os = new OperatingSystem("OS", "NONE");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == osCombo) {
            os.setOsName(Objects.requireNonNull(osCombo.getSelectedItem()).toString());
            System.out.println(osCombo.getSelectedItem());
        }
    }

    public JComboBox getRamCombo() {
        return ramCombo;
    }
